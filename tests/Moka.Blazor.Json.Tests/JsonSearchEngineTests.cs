...
public sealed class JsonSearchEngineTests
{
	...
	public void Search_PlainText_FindsMatches()
	{
		...
		int count = _engine.Search(doc.RootElement, "Alice");
	...
	public void Search_CaseInsensitive_FindsMatches()
	{
		...
		int count = _engine.Search(doc.RootElement, "alice", new JsonSearchOptions { CaseSensitive = false });
	...
	public void Search_CaseSensitive_SkipsNonMatches()
	{
		...
		int count = _engine.Search(doc.RootElement, "alice", new JsonSearchOptions { CaseSensitive = true });
	...
	public void Search_Keys_FindsKeyMatches()
	{
		...
		int count = _engine.Search(doc.RootElement, "userName",
	...
	public void Search_Regex_FindsMatches()
	{
		...
		int count = _engine.Search(doc.RootElement, @"\w+@\w+\.com", new JsonSearchOptions { UseRegex = true });
