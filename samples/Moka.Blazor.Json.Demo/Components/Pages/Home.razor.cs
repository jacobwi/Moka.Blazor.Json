...
public sealed partial class Home : ComponentBase
{
    ...
    // ---- 6. Large array (generated at startup) ----
    private string _largeArrayJson = "[]";

    // ---- 10. Custom context menu actions demo ----
    ...
    private void BuildCustomContextActions()
    {
        ...
        [
            ...
            new MokaJsonContextAction
            {
                ...
                OnExecute = ctx =>
                {
                    if (double.TryParse(ctx.RawValuePreview, out var val))
    ...
    private async Task GenerateStressTest()
    {
        ...
        var targetBytes = (long)_targetSizeMb * 1024 * 1024;
        var nodeCount = 0;
        ...
        while (fileStream.Position < targetBytes)
        {
            ...
            var progress = (int)((double)fileStream.Position / targetBytes * 100);
    ...
    private static string PickRandom(Random rng, params string[] options)
    {
